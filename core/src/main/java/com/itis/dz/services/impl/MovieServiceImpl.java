...
public class MovieServiceImpl implements MovieService {
    ...
    @Autowired
    private IMovieSearchService iMovieSearchService;
    ...
    public void addTestData() {
        ...
        iMovieSearchService.add(movie1);

        movieRepository.addMovie(movie2);
        iMovieSearchService.add(movie2);

        movieRepository.addMovie(movie3);
        iMovieSearchService.add(movie3);

        movieRepository.addMovie(movie4);
        iMovieSearchService.add(movie4);
