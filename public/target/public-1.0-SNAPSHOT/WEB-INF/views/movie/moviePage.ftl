...
<@mainTemplate title="" />
<#macro m_body>
<div class="container well-md"><div class="row">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-6">
            <a href="/movie/add" class="btn btn-xs btn-primary">Редактировать</a>
        </div>
        <div class="col-lg-4 col-md-6">
            <a href="/person/add" class="btn btn-xs btn-primary">Удалить фильм</a>
        </div>
    </div>
    </@sec.authorize>
</div>
